...
while(n <= 100)
    ...
    linclass2 = ClassificationKNN.fit(data,usepat,'NSMethod','exhaustive');
    linclass2.Distance = 'mahalanobis';
    for j = 1:5
    ...
    for i = 1:l1(1)
        ...
        linclass2 = ClassificationKNN.fit(data2,usepat,'NSMethod','exhaustive');
        linclass2.Distance = 'mahalanobis';
        for j = 1:5
